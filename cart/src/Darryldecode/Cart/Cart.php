...
class Cart
{
     ...
     */
    public function add($id, $name = null, $price = null, $quantity = null, $location = null, $referenceNo = null, $attributes = array(), $conditions = array(), $associatedModel = null)
    {
